...
int InputString(char*, int, int, int, std::size_t, const std::string&);
...
int GetCopyParameter(const char*, bool, char*, char*);
int GetMoveParameter(const char*, char*, char*);
...
void Print(WINDOW*, int, int, const std::string&, int);
